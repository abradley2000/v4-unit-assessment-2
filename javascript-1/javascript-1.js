...
let pairsArray = [[0, 4], [1, 8], [2, 5], [3, 6], [7, 9]]
//DO NOT EDIT CODE ABOVE

//CODE HERE

/* Couldn't figure out why this didn't work, assuming it's a Jasmine issue
...
//CODE HERE
    let phone1 = new Phone("iPhone", "12", 512, "Black", true);
  
    let phone2 = new Phone("iPhone", "X", 128, "Blue", false);
  
    let phone3 = new Phone("Samsung", "Galaxy", 128, "Green", true);
